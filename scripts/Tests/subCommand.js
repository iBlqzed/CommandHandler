...
cmd.addSubCommand(new Command({ name: "add" }).addChainedArguments(["string", "all"], (player, [obj, display]) => {
...
cmd.addSubCommand(new Command({ name: "remove" }).addArgument("string", (player, value) => {
